...
head=new JLabel("Update Details");
head.setBounds(106,5,400,40);
...
String sql="update Emp_info set Name=?, Age=?, Mobile=?, Gender=?, Salary=?, Address=? where Id=? ";
...
pst.setInt(7, Id);
pst.executeUpdate();
JOptionPane.showMessageDialog(c,"Employee Records Updated Successfully...");
con.close();
dispose();
Home h=new Home();
